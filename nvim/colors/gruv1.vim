...
function! s:set_highlights() abort
  ...
  if &background ==# 'dark'
    ...
    hi DiffAdd                  guifg=NONE      guibg=#3C3F28   gui=NONE
    hi DiffChange               guifg=NONE      guibg=#493F29   gui=NONE
    hi DiffDelete               guifg=NONE      guibg=#49282A   gui=NONE
    hi DiffText                 guifg=NONE      guibg=#4A3325   gui=NONE
